...
# issue #8584
Build.RATIONAL && @test (0:1//2:2)[1:2:3] == 0:1//1:1
...
# Issue #13738
Build.BIGINT && for r in (big(1):big(2), UInt128(1):UInt128(2), 0x1:0x2)
    rr = r[r]
