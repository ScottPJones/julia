...
Build.BIGINT && @test typeof(convert(BigInt,y)) <: BigInt
Build.BIGFLT && @test typeof(convert(BigFloat,y)) <: BigFloat
...
Build.BIGINT && @test Dates.Year(convert(BigInt,1)) == y
Build.BIGFLT && @test Dates.Year(convert(BigFloat,1)) == y
